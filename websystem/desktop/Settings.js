Ext.define('MyDesktop.Settings', {
    ...
    ckBoxLabel:'Stretching to fix',
    
    deskTitle:'Desktop background',
    ...
    initComponent: function () {
        ...
        me.buttons = [
            { text: me.okBtn, handler: me.onOK, scope: me },
            { text: me.cancleBtn, handler: me.close, scope: me }
        ];
